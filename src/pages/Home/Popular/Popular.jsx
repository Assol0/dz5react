...
import Images from '../../../assets/popular/image 40.svg'
import Images1 from '../../../assets/popular/image 39.svg'
import Images2 from '../../../assets/popular/image 38.svg'
import Images3 from '../../../assets/popular/image 37.svg'
  ...
  return (
    <div className='popular'>
        <div className="container">
            ...
            <div className="popular__component">
                ...
                <div className="popular__component-product">
                    <img src={Images} alt="" />
                    <h2 className='popular__component-title'>REPlay</h2>
                    <p className='popular__component-p'> Classic shoes</p>
                    <span   className='popular__component-price'>6100 UAH</span>
                    <span className='popular__component-span'>3800 UAH</span>
                </div>
                <div className="popular__component-product">
                    <img src={Images1} alt="" />
                    <h2 className='popular__component-title'>REPlay</h2>
